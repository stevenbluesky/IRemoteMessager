...
public class ExportExcel {
    public void exportExcel(String title, String[] headers, Collection<MessageTemplateVo> dataset, OutputStream out, String pattern, HSSFWorkbook workbook) {
        // 声明一个工作薄   生成一个表格
        ...
        // 遍历集合数据，产生数据行
        Iterator<MessageTemplateVo> it = dataset.iterator();
        int index = 0;
        while (it.hasNext()) {
            index++;
